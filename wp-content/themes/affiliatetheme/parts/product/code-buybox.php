<?php global $product_shops; $product_shop = ($product_shops ? $product_shops : get_field('product_shops')); ?>
<div class="product-buybox">
	<div class="row">
		...
		<div class="col-xxs-12 col-xs-6 col-md-12">
			<?php
			echo get_product_button($post->ID, 0, 'buy', 'btn-block btn-lg');

			do_action('at_product_buybox_after_buy_button');

			if (show_price_compare($post->ID)) {
...
<?php echo at_price_trend_render_button($post->ID); ?>
