<?php
$chart = at_price_trend_chart_data($post->ID);
if($chart && !empty($chart['datasets'])) {
    ?>
    <div class="product-price_trend" id="price-trend">
        <?php if(at_show_price_trend($post->ID, 'bottom')) { ?>
        ...
        var data = {
            ...
            datasets: [
                ...
                foreach($chart['datasets'] as $k => $v) {
                    ...
                    ?>
                    {
                        label: "<?php echo get_the_title($k); ?>",
                        fill: false,
                        lineTension: 0,
                        backgroundColor: "<?php echo $colors['backgroundColor']; ?>",
                        borderColor: "<?php echo $colors['borderColor']; ?>",
                        borderCapStyle: 'butt',
                        borderDash: [],
                        ...
                        pointRadius: 4,
                        pointBorderColor: "<?php echo $colors['pointBorderColor']; ?>",
                        pointBackgroundColor: "#fff",
                        pointBorderWidth: 2,
						
                        pointHoverRadius: 5,
                        pointHoverBorderColor: "<?php echo $colors['pointHoverBorderColor']; ?>",
