...
<div class="post-postnav">
	<nav>
		<ul class="pager">
			<?php if($prev_post) : ?>
				<li class="previous">
					<a rel="prev" href="<?php echo get_permalink($prev_post->ID); ?>" title="<?php _e('zum Vorherigen Artikel', 'affiliatetheme'); ?>">
			...
			<?php if($next_post) : ?>
				<li class="next">
					<a rel="next" href="<?php echo get_permalink($next_post->ID); ?>" title="<?php _e('zum Nächsten Artikel', 'affiliatetheme'); ?>">
