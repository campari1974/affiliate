...
function twitterbootstrap_galleries_get_grid_classes($numberofcolumns) {
    switch($numberofcolumns) {
        case 9: $classes = 'col-xxs-12 col-xs-6 col-sm-3 col-md-2'; break;
        case 8: $classes = 'col-xxs-12 col-xs-6 col-sm-3 col-md-2'; break;
        case 7: $classes = 'col-xxs-12 col-xs-6 col-sm-3 col-md-2'; break;
        case 6: $classes = 'col-xxs-12 col-xs-6 col-sm-4 col-md-2'; break;
        case 5: $classes = 'col-xxs-12 col-xs-6 col-sm-4 col-md-15'; break;
        case 4: $classes = 'col-xxs-12 col-xs-6 col-sm-6 col-md-3'; break;
        case 3: $classes = 'col-xxs-12 col-xs-6 col-sm-4 col-md-4'; break;
        case 31: $classes = 'col-xxs-12 col-xs-6 col-sm-6 col-md-4'; break;
        case 2: $classes = 'col-xxs-12 col-xs-6 col-sm-6 col-md-6'; break;
        case 1: $classes = 'col-xs-12'; break;
        default: $classes = 'col-xxs-12 col-xs-6 col-sm-3';
    }
