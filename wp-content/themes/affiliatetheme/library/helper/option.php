...
if ( ! function_exists( 'get_wrapper_id' ) ) {
	/**
	...
	function get_wrapper_id() {
		...
		if(has_filter('at_get_wrapper_id')) {
			return apply_filters('at_get_wrapper_id', '', $setting);
		}
...
if ( ! function_exists( 'get_section_layout' ) ) {
	/**
	 * get_section_layout function.
	 *
	 * @return string
	 */
...
if ( ! function_exists( 'get_section_layout_class' ) ) {
	/**
	 * get_section_layout_class function.
	 *
...
if ( ! function_exists( 'get_search_post_types' ) ) {
	/**
	 * get_search_post_types function.
	 *
	 * @return array
	 */
