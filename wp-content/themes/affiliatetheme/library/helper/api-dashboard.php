	...
	function affiliatetheme_import_dashboard() {
		...
		<div class="wrap" id="xcore-page">
			...
			<div class="content-wrapper">
				...
				$extensions_feed = 'http://affiliatetheme.io/wp-json/at/v1/extensions?lang=' . $lang;
				if( ini_get('allow_url_fopen') ) {
					...
					if($extensions) {
						...
						printf(__('Ooops, es wurden keine Extensions gefunden, was ist denn hier los? Schau mal auf <a href="%s" target="_blank">unserer Webseite</a> nach.', 'affiliatetheme-backend'), 'http://affiliatetheme.io/extensions/');
					}
				} else {
					printf(__('Ooops, eine Serverfunktion (allow_url_fopen) fehlt bei Dir, wir können die Liste nicht laden. Schau mal auf <a href="%s" target="_blank">unserer Webseite</a> nach.', 'affiliatetheme-backend'), 'http://affiliatetheme.io/extensions/');
				}
				?>
			</div>
		</div>
