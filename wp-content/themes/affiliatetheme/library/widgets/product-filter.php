...
class at_product_filter_widget extends WP_Widget {
	public function __construct() { 
		...
		parent::__construct('at_product_filter_widget', __('affiliatetheme.io &raquo; Filter (NEU)', 'affiliatetheme-backend'), $widget_ops);
	}
...
add_action( 'widgets_init', 'at_product_filter_widget' );
function at_product_filter_widget() {
