...
class AT_Filter_Field {
	...
	private function show_price() {
		...
		<div class="form-group">
			...
			<div class="slide">
				...
				<input id="<?php echo $this->id; ?>" name="<?php echo $this->name; ?>" data-slider-label="<?php echo apply_filters('at_filter_price_label', ' ' . at_get_default_currency(true)); ?>" type="text" class="bt-slider" value="<?php if($this->value) { echo $this->value; } ?>" data-slider-min="<?php echo $values->min; ?>" data-slider-max="<?php echo $values->max; ?>" data-slider-step="<?php echo $steps; ?>" data-slider-value="[<?php if($this->value) { echo $this->value; } else { echo $values->min . ',' . $values->max; }?>]" >
	...
	private function show_rating() {
		...
		<div class="form-group">
			...
			<div class="slide">
				<span><?php echo $values->min; ?></span>
				<input id="<?php echo $this->id; ?>" name="<?php echo $this->name; ?>" data-slider-label="<?php echo apply_filters('at_filter_rating_label', __(' Sterne', 'affiliatetheme')); ?>" type="text" class="bt-slider" value="<?php if($this->value) { echo $this->value; } ?>" data-slider-min="<?php echo $values->min; ?>" data-slider-max="<?php echo $values->max; ?>" data-slider-step="<?php echo $steps; ?>" data-slider-value="[<?php if($this->value) { echo $this->value; } else { echo $values->min . ',' . $values->max; }?>]" >
				<span><?php echo $values->max; ?></span>
			</div>
			<?php echo ($instruction ? '<span class="filter-instruction">' . $instruction . '</span>' : ''); ?>
			<div class="clearfix"></div>
	...
	private function show_taxonomy() {
		...
		if($tax) {
			...
			if ($terms) {
				...
				<div class="form-group">
					<label for="<?php echo $this->id; ?>" class="control-label"><?php echo $title; ?></label>
					<select id="<?php echo $this->id; ?>" name="<?php echo $tax->name; ?>" class="form-control">
						<option value=""><?php echo $first_label; ?></option>
                        <?php echo at_get_terms_hierarchical($terms, '', 0, 0, $this->value); ?>
					</select>
					<?php echo($instruction ? '<span class="filter-instruction">' . $instruction . '</span>' : ''); ?>
					<div class="clearfix"></div>
				</div>
	...
	private function show_custom_field() {
		...
		if ($type == 'number') {
			...
			<div class="form-group"<?php if($this->is_hide($this->field)) echo ' style="display: none;"'; ?>>
				...
				<div class="slide">
					<span><?php echo $values->min; ?></span>
					<input id="<?php echo $this->id; ?>" name="<?php echo $this->name; ?>" data-slider-label="<?php echo apply_filters('at_filter_customfield_label', $append, $this->field_object); ?>" type="text" class="bt-slider" value="<?php if($this->value) { echo $this->value; } ?>" data-slider-min="<?php echo $values->min; ?>" data-slider-max="<?php echo $values->max; ?>" data-slider-step="<?php echo $steps; ?>" data-slider-value="[<?php if($this->value) { echo $this->value; } else { echo $values->min . ',' . $values->max; }?>]" >
					<span><?php echo $values->max; ?></span>
				</div>
				<?php echo ($instruction ? '<span class="filter-instruction">' . $instruction . '</span>' : ''); ?>
				<div class="clearfix"></div>
			...
			<div class="form-group"<?php if($this->is_hide($this->field)) echo ' style="display: none;"'; ?>>
				<label for="<?php echo $this->id; ?>" class="control-label"><?php echo $title; ?></label>
				<select name="<?php echo $this->name; ?>" id="<?php echo $this->id; ?>" class="form-control">
