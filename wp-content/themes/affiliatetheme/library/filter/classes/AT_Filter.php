...
class AT_Filter {
	...
	public function build() {
		?>
		<form action="<?php echo $this->target(); ?>" method="<?php echo $this->method; ?>" class="<?php echo $this->form_classes(); ?>" data-ajax="<?php echo ($this->is_ajax() ? 'true' : 'false'); ?>" data-id="<?php echo $this->post_id; ?>">
			<?php
			// render fields
			echo $this->fields();
	...
	public function submit_button() {	
		...
		if($filter_submit_label) $label = $filter_submit_label;
