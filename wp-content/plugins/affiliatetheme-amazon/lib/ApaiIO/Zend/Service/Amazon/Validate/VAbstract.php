...
namespace ApaiIO\Zend\Service\Amazon\Validate;
...
/**
 * Class VAbstract
 * @package ApaiIO\Zend\Service\Amazon\Validate
 *
 * @todo: remove Zend_Translate DO REFACTOR;
 */

abstract class VAbstract implements VInterface
{
    /**
     ...
     * @return VAbstract Provides a fluent interface
     * @throws \Exception
     */
