...
abstract class Uri
{
     ...
     * @throws Exception When $className doesn't exist or doesn't implements Zend_Uri
     * @return Uri
    ...
    public static function factory($uri = 'http', $className = null)
    {
        ...
        if (! $schemeHandler instanceof Uri) {
            throw new Exception("\"$className\" is not an instance of Zend_Uri");
        }
     ...
     * Use Uri::factory() to return a new Zend_Uri object.
     *
