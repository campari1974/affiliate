<?php
/**
 * Plugin Name: AffiliateTheme - Zanox Schnittstelle
 * Plugin URI: http://affiliatetheme.io
 * Description: Dieses Plugin erweitert das AffiliateTheme um eine Zanox Schnittstelle
 * Version: 1.2.1
 * Author: endcore Medienagentur
 * Author URI: http://endcore.com
 * License: GPL2
 */ 
if(!class_exists('AffiliateTheme_Zanox')) {
	class AffiliateTheme_Zanox {
		/**
		...
		public function __construct()
		{
			...
			$affiliatetheme_zanox_dashboard = new AffiliateTheme_Zanox_Dashboard_Init();

			require 'plugin-update-checker/plugin-update-checker.php';
			$myUpdateChecker = PucFactory::buildUpdateChecker(
				'http://update.affiliatetheme.io/affiliatetheme-zanox.json',
				__FILE__
			);
...
if(class_exists('AffiliateTheme_Zanox'))
{
	$affiliatetheme_zanox = new AffiliateTheme_Zanox();
}