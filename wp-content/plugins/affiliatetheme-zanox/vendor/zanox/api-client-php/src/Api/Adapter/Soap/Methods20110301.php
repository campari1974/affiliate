...
class Methods20110301 extends AbstractApiMethods implements Methods20110301Interface
{
    ...
    public function getProduct($productId, $adspaceId = NULL)
    {
        ...
        $result = $this->doSoapRequest(ApiConstants::SERVICE_PUBLISHER, $method, $parameter);
    ...
    public function getProgramCategories()
    {
        ...
        $result = $this->doSoapRequest(ApiConstants::SERVICE_PUBLISHER, $method);
    ...
    public function getSession($authToken)
    {
        ...
        $result = $this->doSoapRequest(ApiConstants::SERVICE_CONNECT, $method, $parameter);
     ...
     *
     * @param      string $offlineToken authentication token
     *
     *
     * @return     object                      user session
     */
