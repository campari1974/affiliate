 ...
 */
class Methods20150501 extends AbstractApiMethods implements Methods20150501Interface
{
     ...
     */
    public function searchIncentives(
        $programId = NULL,
        $adspaceId = NULL,
        $incentiveType = NULL,
        $region = NULL,
     ...
     * @return      object or string            list of incentives or false
     */
    public function searchExclusiveIncentives(
        $programId = NULL,
        $adspaceId = NULL,
        $incentiveType = NULL,
        $region = NULL,
     ...
     * @param       float|int $pricingShare price for share model (optional)
     * @param       float|int $pricingSetup price for setup (optional)
     * @param       float|int $pricingMonthly price for monthly usage (optional)
    ...
    )
    {
        ...
        $this->setRestfulAction(ApiConstants::POST);
        $this->setSecureApiCall(true);
    ...
    )
    {
        ...
        $this->setRestfulAction(ApiConstants::PUT);
        $this->setSecureApiCall(true);
    ...
    public function deleteApplication($applicationId)
    {
        ...
        $this->setRestfulAction(ApiConstants::DELETE);
        $this->setSecureApiCall(true);
     ...
     * @param       string $key application specific key
     *
     * @category    signature
     *
     * @return      string|bool            application item or false
     */
     ...
     *
     * @param       int $applicationId application id (mandatory)
     * @param       int $mediaslotId mediaslot id (optional)
     * @param       string $key settings key (mandatory)
     *
     * @category    signature
     *
     ...
     */
    public function getMediaSlot($mediaslotId = null)
    {
     ...
     * @return      object or string                    list of media slot objects or false
     */
    public function createMediaSlot(
        $name,
        $adspaceId,
        $adspaceName = NULL,
        $applicationId,
     ...
     * @return      object or string                    list of media slot objects or false
     */
    public function updateMediaSlot(
        $mediaslotId,
        $name,
        $adspaceId,
        $adspaceName = NULL,
     ...
     */
    public function getProgramApplications(
        $programId = NULL,
        $adspaceId = NULL,
        $status = NULL,
        $page = 0,
     ...
     */
    public function getReportBasic(
        $fromDate,
        $toDate,
        $dateType = NULL,
        $currency = NULL,
    ...
    )
    {
        ...
        $body = $this->serialize('adspaceItem', $adspaceItem);
