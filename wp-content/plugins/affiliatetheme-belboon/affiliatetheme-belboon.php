<?php
/**
 * Plugin Name: AffiliateTheme - Belboon Schnittstelle
 * Plugin URI: http://affiliatetheme.io
 * Description: Dieses Plugin erweitert das AffiliateTheme um eine Belboon Schnittstelle
 * Version: 1.3.2
...
if(!class_exists('AffiliateTheme_Belboon')) {
	class AffiliateTheme_Belboon{
		/**
		...
		public function __construct()
		{
			...
			$affiliatetheme_belboon_dashboard = new AffiliateTheme_Belboon_Dashboard_Init();

			require 'plugin-update-checker/plugin-update-checker.php';
			$myUpdateChecker = PucFactory::buildUpdateChecker(
				'http://update.affiliatetheme.io/affiliatetheme-belboon.json',
				__FILE__
			);
		...
		{
		    wp_clear_scheduled_hook('affiliatetheme_belboon_api_update', array('hash' => BBOON_CRON_HASH));
		}
...
if(class_exists('AffiliateTheme_Belboon'))
{
	$affiliatetheme_belboon = new AffiliateTheme_Belboon();
}
